        ...
        <div class="cont-btns">
            ...
            <ul class="nav-lista-btns">
                ...
                <li class="btns user-dropdown"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" onclick="bandejaUsuario(event)"><circle cx="12" cy="6" r="4" fill="currentColor " class="nav-icono"/><path class="nav-icono"fill="currentColor" d="M20 17.5c0 2.485 0 4.5-8 4.5s-8-2.015-8-4.5S7.582 13 12 13s8 2.015 8 4.5"/></svg></li>
                    <div class="user-dropdown-content" id="userDropdown" style="display:none;">
                        <div class="user-info">
                            <img src="<?= isset($_SESSION['foto']) ? $_SESSION['foto'] : 'perfil.png' ?>" alt="Foto de perfil" class="user-avatar" style="width:48px;height:48px;border-radius:50%;">
    ...
    <?php endif;
        ...
        <nav class="nav">
            ...
            <div class="cont-btns">
                <ul class="nav-lista-btns">
                    <li class="btns">
                        <button class="iniciar-sesion" onclick="location.href='login.php'">
                    ...
                    <li class="btns"> 
                        <button class="registrarse" onclick="location.href='diferenciacion-register.php'">
