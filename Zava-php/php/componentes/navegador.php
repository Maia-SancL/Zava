<?php
// Asegúrate de NO setear $_SESSION['tipo_usuario'] manualmente aquí
        ...
        <nav class="nav">
            <div class="cont-btns">
                <ul class="nav-lista-btns">
                    ...
                    <li class="btns"><a href="/Zava-php/php/admin/panelAdmin.php">Panel</a></li>
                    <li class="btns"><a href="/Zava-php/php/admin/usuarios.php">Usuarios</a></li>
                    <li class="btns"><a href="/Zava-php/php/admin/reportes.php">Reportes</a></li>
                    <li class="btns"><a href="/Zava-php/php/admin/configuracion.php">Configuración</a></li>
                    <li class="btns">
                        <form action="/Zava-php/php/componentes/funciones/cerrarSesion.php" method="POST" style="display:inline;">
                            <button type="submit" class="logout-btn">Cerrar sesión</button>
                        </form>
                    </li>
                </ul>
