        ...
        <header>
            <div class="cont-titulo">
                <div class="cont-img-logo">
                    <img class="img-logo select-none" src="../css/recursos/3.0.png">
                </div>
                <h1 class="titulo-principal select-none">Zava</h1>
            </div>
        ...
        <section id="recetas">
            ...
            <div class="cont-btns-recetas">
                <div class="btn-receta">
                    <p class="lbl-tipo-receta"></p>
                    <div class="cont-img-tipo-receta">
                        <img src="../css/recursos/Desayuno.jpg">
                    </div> 
                </div>
                <div class="btn-receta">
                    <p class="lbl-tipo-receta"></p>
