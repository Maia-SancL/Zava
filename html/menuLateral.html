        ...
        <ul class="barra-lista">
            ...
            <li class="barra-elemento">
             ...
             <li class="barra-elemento">
                ...
                <li class="barra-elemento submenu">
                        <a href="">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 48 48"><g  class="barra-icono" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="4"><path fill="currentColor" d="M42 36V20H14v16a6 6 0 0 0 6 6h16a6 6 0 0 0 6-6"/><path d="M4 20h40M18 8v4m10-6v6m10-4v4"/></g></svg>
                        <p class="barra-texto">Recetas</p>
                        </a>
                    </li>
                    <li class="barra-elemento submenu">
        ...
        <nav class="nav">
            ...
            <div class="cont-btns">
                <ul class="nav-lista-btns">
                    ...
                    <li class="btns"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><circle cx="12" cy="6" r="4" fill="currentColor " class="nav-icono"/><path class="nav-icono"fill="currentColor" d="M20 17.5c0 2.485 0 4.5-8 4.5s-8-2.015-8-4.5S7.582 13 12 13s8 2.015 8 4.5"/></svg></li>
                </ul>
