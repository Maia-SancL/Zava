...
?>
<link rel="stylesheet" href="/Zava/css/comercio/perfilComercio.css">
<link rel="stylesheet" href="/Zava/css/comercio/modalPerfilComercio.css">
<aside>
    <main>
...
<script src="/Zava/js/comercio/perfilNav.js"></script>
<script src="/Zava/js/comercio/modalPerfil.js"></script>
...
<div id="editProfileModal" class="modal">
    <div class="modal-content">
        ...
        <h2>Editar Perfil</h2>
        <form id="editProfileForm" action="/Zava/php/comercio/funciones/actualizarPerfil.php" method="POST" enctype="multipart/form-data">
        ...
        <div class="advanced-settings-section">
            ...
            <form id="changeEmailFormComercio" action="/Zava/php/comercio/funciones/iniciarCambioCorreo.php" method="POST">
                <div class="form-group">
        ...
        <div class="delete-section">
            ...
            <form id="deleteAccountRequestForm" action="/Zava/php/comercio/funciones/iniciarEliminacion.php" method="POST">
