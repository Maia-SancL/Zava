...
<head>
    ...
    <link rel="stylesheet" href="/Zava/css/comercio/modificar-producto.css">
</head>
<body>
        ...
        <section class="modificar-producto-container">
            ...
            <form action="actualizarProducto.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <img src="/Zava/img/productos/<?= htmlspecialchars($producto['imagen_principal']) ?>" alt="Imagen actual" width="100">
                </div>
