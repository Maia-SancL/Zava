...
?>
<link rel="stylesheet" href="/Zava/css/comercio/comercio-productos.css">
    <main>
        <section class="section-titulo-btn">
            <h2 class="subtitulo">Productos</h2>
            <a href="comercio-agregar-producto.php" class="btn-agregar-producto">
                    ...
                    while ($producto = mysqli_fetch_assoc($resultado)) {
                        ...
                        <article class="producto">
                            <div class="informacion-principal">
                                ...
                                <div class="btns">
                                    <a href="/Zava/php/comercio/funciones/modificarProducto.php?id=<?= $producto['id_producto'] ?>" class="btn-modificar">
                                    ...
                                    <form action="/Zava/php/comercio/funciones/eliminarProducto.php" method="POST" onsubmit="return confirm('¿Estás seguro de que quieres eliminar este producto?');" style="display: inline;">
                                    ...
                                    <form action="/Zava/php/comercio/funciones/agregarStock.php" method="POST" class="form-agregar-stock" style="display: inline;">
                                        <input type="hidden" name="id_producto" value="<?= $producto['id_producto'] ?>">
                            ...
                            <div class="detalles-producto oculto">
                                ...
                                <div class="cont-img">
                                    <img src="/Zava/img/productos/<?= htmlspecialchars($producto['imagen_principal']) ?>" alt="Imagen de <?= htmlspecialchars($producto['nombre']) ?>">
                                </div>
                            </div>
                        </article>
                    <?php }
    ...
    <script src="/Zava/js/comercio/panelComercio.js"></script>
</body>
</html>