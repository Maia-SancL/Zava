...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (!isset($_SESSION['id'])) {
        ...
        header('Location: comercio-agregar-producto.php');
        exit();
    }
    ...
    if (!empty($_FILES['imagen-producto']['name'])) {
        $target_dir = $_SERVER['DOCUMENT_ROOT'] . "/Zava/img/productos/";
...
?>
<link rel="stylesheet" href="/Zava/css/comercio/comercio-agregar-producto.css">
    <main>
...
<script src="/Zava/js/comercio/agregarProducto.js"></script>