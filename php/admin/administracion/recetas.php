            ...
            <article class="producto">
                <div class="informacion-principal">
                    ...
                    <div class="detalles-producto oculto">
                        <div class="cont-img">
                            <img src="/Zava/img/recetas/<?= htmlspecialchars($receta['imagen']) ?>" alt="Imagen de <?= htmlspecialchars($receta['nombre']) ?>" style="height:80px;max-width:80px;object-fit:cover;">
                        </div>
                    ...
                    <div class="btns">
                        <form action="/Zava/php/admin/funciones/eliminarReceta.php" method="POST" onsubmit="return confirm('¿Estás seguro de que quieres eliminar esta receta?');" style="display: inline;">
...
<section class="paginacion">
    <?php if ($total_paginas > 1): ?>
        <?php for ($i = 1; $i <= $total_paginas; $i++): ?>
            <a href="?seccion=recetas&pagina=<?= $i ?>" class="<?= ($i == $pagina_actual) ? 'active' : '' ?>"><?= $i ?></a>
        <?php endfor; ?>
    <?php endif; ?>
</section>

<script src="/Zava/js/admin/panelAdministracion.js"></script>
