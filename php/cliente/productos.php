                ...
                <article onclick="location.href='mostrarProducto.php?id_producto=<?php echo $fila['id_producto']; ?>'" class="producto">
                    <div class="cont-img">
                        ...
                        <div class="cont-oferta-favorito"> 
                            ...
                            <div class="cont-oferta">
                                <p>%<?php echo $fila['descuento'];?> off</p>
                            </div>
                            <?php }; ?>
                    ...
                    <div class="informacion-producto"> 
                        ...
                        <div class="cont-precio-btn">
                            <?php if($fila['descuento']>0){
                                $precioConDescuento=$fila['precio']*($fila['descuento']/100);?>
                            <?php };
                            $precio = $fila['precio'];?>
                            <span class="precio">$<?php echo number_format($precio, 2, ',', '.')?></span>
                                <?php if($fila['descuento']>0){?>
                                <span class="precio-oferta"><?php echo $fila['precio'];?></span> <!--SOLO SE MOSTRARA SI EL PRODUCTO ESTA EN OFERTA--> 
                                <?php } ?>
