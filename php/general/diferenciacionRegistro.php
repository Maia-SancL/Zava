...
<main class="main-tipo-user">
    ...
    <section class="section-opciones-user">
        <form action="register.php" method="get" class="tipo usuario">
            <button type="submit" class="btn-tipo" name="tipo-user">
        ...
        <form action="register.php" method="get" class="tipo comercio">
            <button type="submit" class="btn-tipo" name="tipo-user">
