...
<div class="layout">
    ...
    <link rel="stylesheet" href="/Zava/cliente/css/recetario.css">
    <main>
        <?php include $_SERVER['DOCUMENT_ROOT'] . '/Zava/public/componentes/php/navegador.php';?>
        <section class="section-filtros">
            <form action="<?php echo BASE_URL; ?>recetario" method="GET" id="filtros-recetas">
    ...
    <div class="cont-resultados-select">
        ...
        <form action="<?php echo BASE_URL; ?>recetario" method="get" id="form-orden">
    ...
    while ($fila = $result->fetch_assoc()) {
        $ruta_imagen = BASE_URL . 'public/img/recetas/' . $fila['imagen_principal'];
        ?>
                    <article onclick="location.href='<?php echo BASE_URL; ?>receta?id_receta=<?php echo $fila['id_receta']; ?>'" class="receta-especifica">
                <div class="cont-img">
                    <!-- Imagen de la receta-->
...
?><script src="/Zava/cliente/js/recetario.js"></script>
?>