...
?>
<link rel="stylesheet" href="/Zava/cliente/css/carrito.css">
<div class="layout">
    ...
    <main>  
        ...
        <section class="carrito-container">
            <section class="contenedor productos">
                ...
                <?php else: ?>
                    <?php foreach ($productos_info as $id => $producto): 
                        $ruta_imagen = BASE_URL . "public/img/productos/" . ($producto['imagen'] ?? 'producto.jpg');
                    ?>
                        <div class="producto">
                            <div class="contenedor-producto eliminar">
                                <form action="<?php echo BASE_URL; ?>carrito" method="post" class="form-eliminar">
            ...
            <section class="contenedor resumen">
                ...
                <a href="<?php echo BASE_URL; ?>facturacion" class="btn-comprar">Procesar pago</a>
            </section>
        </section>
    </main>
