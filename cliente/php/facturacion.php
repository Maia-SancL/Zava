...
if (empty($_SESSION['carrito'])) {
    header('Location: /Zava/cliente/php/carrito.php');
    exit();
}
...
?>
<link rel="stylesheet" href="/Zava/cliente/css/facturacion.css">
<div class="layout">
    ...
    <main>
        ...
        <div class="container">
            <div class="form-section">
                <form action="/Zava/cliente/php/funciones/procesarPago.php" method="POST" id="form-pago">
