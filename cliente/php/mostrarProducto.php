...
$rutaImagenProducto = "/Zava/public/img/productos/" . $imagen_producto;

$nickname_comercio = $usuario['nickname'];
$foto_usuario_comercio = $usuario['foto'] ? $usuario['foto'] : 'perfil.png';
$rutaImagenComercio = "/Zava/public/img/perfiles/" . $foto_usuario_comercio;
...
<div class="layout">
    ...
    <link rel="stylesheet" href="/Zava/cliente/css/mostrarProducto.css">
    <main>
...
?>
<script src="/Zava/cliente/js/favoritos.js"></script>
<script src="/Zava/cliente/js/producto.js"></script>
