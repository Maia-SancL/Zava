...
include $_SERVER['DOCUMENT_ROOT'] . '/Zava/public/componentes/php/funciones/tags.php';
...
if (isset($_GET['id_receta']) && is_numeric($_GET['id_receta']) && intval($_GET['id_receta']) > 0) {
    ...
    if (!$receta) {
        ...
        $query_usuario = "SELECT id_usuario, nombre, apellido, nickname, imagen FROM Usuarios WHERE id_usuario = $id_usuario";
...
<div class="layout">
    ...
    <link rel="stylesheet" href="/Zava/cliente/css/mostrarReceta.css">
    <main>
        ...
        <?php 
        $rutaPrincipal = BASE_URL . "public/img/recetas/" . $receta['imagen_principal'];
        ?>
        <article class="cont-imagenes-receta">
            ...
            <div class="cont-img-derecha">
                <?php foreach ($imagenes_adicionales as $index => $img_path): ?>
                    <div class="cont-img">
                        <img src="<?php echo BASE_URL; ?>public/img/recetas/<?= htmlspecialchars($img_path) ?>" alt="Imagen adicional de la receta <?= $index + 1 ?>">
                    </div>
                <?php endforeach; ?>
            </div>
        </article>
        ...
        <section class="info-princiapl">
                <?php $rutaImg = BASE_URL . "public/img/perfiles/". $usuario_receta['imagen'];?>
                <div class="cont-img">
        ...
        <?php include $_SERVER['DOCUMENT_ROOT'] . '/Zava/public/componentes/php/mostrarComentarios.php';?>
    </main>
</div>
<?php 
include $_SERVER['DOCUMENT_ROOT'] . '/Zava/public/componentes/php/footer.php';
?>
  <script src="/Zava/cliente/js/comentarios.js"></script>
  <script src="<?php echo BASE_URL; ?>cliente/js/favoritos.js"></script>
