...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (
        ...
        if (!empty($_FILES['imagenes']['name'][0])) {
            $target_dir = $_SERVER['DOCUMENT_ROOT'] . "/Zava/public/img/recetas/";
...
?>
<link rel="stylesheet" href="/Zava/cliente/css/crear-receta.css">

<main>
    <div class="crear-receta">
        <form action="<?php echo BASE_URL; ?>crear-receta" method="POST" enctype="multipart/form-data" class="form-receta">
...
<script src="/Zava/cliente/js/crearReceta.js"></script>
<script src="/Zava/cliente/js/preview-imagenes-receta.js"></script>