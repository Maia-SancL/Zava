<?php
session_start();
include $_SERVER['DOCUMENT_ROOT'] . '/Zava/public/componentes/header.php';
...
?>
<link rel="stylesheet" href="<?php echo BASE_URL; ?>public/css/cliente/perfil-inicio.css">
<link rel="stylesheet" href="<?php echo BASE_URL; ?>public/css/cliente/perfil-recetas.css">
<link rel="stylesheet" href="<?php echo BASE_URL; ?>public/css/cliente/editarPerfil.css">

    <?php require_once($_SERVER['DOCUMENT_ROOT'].'/Zava/public/componentes/funciones/tags.php'); ?>
<main>
    <?php
    ...
    <div class="cont-nav">
        <div onclick="location.href='<?php echo BASE_URL; ?>perfil'" class="caja-nav">
            <a>Favoritos</a>
        </div>
        <div onclick="location.href='<?php echo BASE_URL; ?>perfil/historial'" class="caja-nav">
            <a>Ultimo Visto</a>
        </div>
        <div onclick="location.href='<?php echo BASE_URL; ?>perfil/pedidos'" class="caja-nav">
            <a>Pedidos</a>
        </div>
        <div onclick="location.href='<?php echo BASE_URL; ?>perfil/opiniones'" class="caja-nav">
            <a>Opiniones</a>
        </div>
        <div onclick="location.href='<?php echo BASE_URL; ?>perfil/recetas'" class="caja-nav seleccionado">
            <a>Mis Recetas</a>
        </div>
    </div>
    ...
    <?php
            ...
            if (mysqli_num_rows($resultado_recetas) > 0) {
                while ($receta = mysqli_fetch_assoc($resultado_recetas)) {
                    $ruta_imagen_receta = BASE_URL . "public/img/recetas/" . $receta['imagen_principal'];
    ...
    <div class="global">
                        ...
                        <div class="receta">
                            ...
                            <div class="contGlobal">
                                ...
                                <div class="botonGlobal">
                                                                        <div class="botonModificar" onclick="location.href='<?php echo BASE_URL; ?>cliente/modificar-receta?id=<?php echo $receta['id_receta']; ?>'">
            ...
            <?php
                ...
                echo "<div class='no-recetas'><p>Aún no has creado ninguna receta. ¡Animate a compartir tus propias recetas!</p> <a href='" . BASE_URL . "crear-receta' class='btn-crear-receta'>Crear mi primera receta</a></div>";
            }
            ?>
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            <form action="<?php echo BASE_URL; ?>cliente/actualizar-perfil" method="post" enctype="multipart/form-data" id="form-perfil">
...
<script src="<?php echo BASE_URL; ?>public/js/cliente/modalPerfil.js"></script>
    <?php include $_SERVER['DOCUMENT_ROOT'] . '/Zava/public/componentes/footer.php'; ?>
    <script src="<?php echo BASE_URL; ?>public/js/cliente/perfilRecetas.js"></script>
