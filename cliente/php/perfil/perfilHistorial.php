...
include_once($_SERVER['DOCUMENT_ROOT'] . '/Zava/public/componentes/funciones/tags.php');
if (!isset($conexion)) {
...
<link rel="stylesheet" href="<?php echo BASE_URL; ?>public/css/cliente/perfilHistorial.css">
...
<main>
    ...
    <div class="cont-nav">
        ...
        <div onclick="location.href='<?php echo BASE_URL; ?>perfil/recetas'" class="caja-nav">
            <p>Mis Recetas</p>
        </div>
    </div>
    <?php
                    ...
                    <div class="globalVistos">
                        ...
                        <?php if ($resultado_hoy && mysqli_num_rows($resultado_hoy) > 0): ?>
                            ...
                            while ($item = mysqli_fetch_assoc($resultado_hoy)):
                                ...
                                if ($tipo == 'receta') {
                                    $url = BASE_URL . "receta?id=$id_contenido";
                                    $ruta_imagen = BASE_URL . "public/img/recetas/" . $imagen; // Siempre tomar el nombre de imagen principal
                                } else {
                                    $url = BASE_URL . "producto?id=$id_contenido";
                                    $ruta_imagen = BASE_URL . "public/img/productos/" . $imagen; // Siempre tomar el nombre de imagen principal
                                }
...
<?php 
include $_SERVER['DOCUMENT_ROOT'] . '/Zava/public/componentes/footer.php';
?>
<script src="<?php echo BASE_URL; ?>public/js/cliente/modalPerfil.js"></script>
<script src="<?php echo BASE_URL; ?>public/js/cliente/perfilHistorial.js"></script>
<script src="<?php echo BASE_URL; ?>public/js/cliente/filtroHistorial.js"></script>