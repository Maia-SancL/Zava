...
if (isset($_FILES['foto']) && $_FILES['foto']['error'] == 0) {
    ...
    if ($usuario_actual && $usuario_actual['foto'] && $usuario_actual['foto'] !== 'perfil.png') {
        $ruta_foto_anterior = $_SERVER['DOCUMENT_ROOT'] . '/Zava/public/img/perfiles/' . $usuario_actual['foto'];
    ...
    $directorio_subida = $_SERVER['DOCUMENT_ROOT'] . '/Zava/public/img/perfiles/';
    ...
    if (move_uploaded_file($_FILES['foto']['tmp_name'], $fichero_subido)) {
        ...
        header('Location: /Zava/cliente/php/perfil/perfil.php');
        exit();
    }
}
