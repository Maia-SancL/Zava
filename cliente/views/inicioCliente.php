<div class="layout">
    <?php include_once 'public/componentes/php/menuLateral.php';?>
    <main>  
    <link rel="stylesheet" href="/Zava/public/css/index.css">
    <?php include_once 'public/componentes/php/navegador.php';?>
  <header class="header-titulo" id="inicio">
            <div class="cont-titulo">
                <img class="img-logo select-none" src="/Zava/public/recursos/Principal 2.0.png">
            </div>
        ...
        <section id="recetas">
            ...
            <div class="cont-btns-recetas">
                <div class="btn-receta">
                    <form method="GET" action="<?php echo BASE_URL; ?>recetario" style="height:100%;">
                        ...
                        <div class="tarjeta-receta">
                                ...
                                <img src="/Zava/public/recursos/Desayuno.jpg">
                            </div>
                        </button>
                    </form>
                ...
                <div class="btn-receta">
                    <form method="GET" action="<?php echo BASE_URL; ?>recetario" style="height:100%;">
                        ...
                        <button type=submit style="background: none; border: none; padding: 0; cursor: pointer; height:100%">
                            <div class="tarjeta-receta">
                                <div class="overlay"></div> <!--Capa oscura -->
                                <img src="/Zava/public/recursos/Almuerzo.jpg">
                            </div> 
                        </button>
                    </form>
                ...
                <div class="btn-receta">
                    <form method="GET" action="<?php echo BASE_URL; ?>recetario" style="height:100%;">
                        ...
                        <button type=submit style="background: none; border: none; padding: 0; cursor: pointer; height:100%">
                            <div class="tarjeta-receta">
                                <div class="overlay"></div> <!-- Capa oscura -->
                                <img src="/Zava/public/recursos/Merienda.jpg">
                            </div> 
                        </button>
                    </form>
                    ...
                    <form method="GET" action="<?php echo BASE_URL; ?>recetario" style="height:100%;">
                        <input type="hidden" name="tipo_comida" value="cena">
                         <button type=submit style="background: none; border: none; padding: 0; cursor: pointer;  height:100%">
                            <div class="tarjeta-receta">
                                <div class="overlay"></div> <!-- Capa oscura -->
                                <img src="/Zava/public/recursos/Cena.jpg">
                            </div> 
                        </button>
                     </form>
                ...
                <div class="btn-receta">
                    <form method="GET" action="<?php echo BASE_URL; ?>recetario" style="height:100%;">
                        ...
                        <button type=submit style="background: none; border: none; padding: 0; cursor: pointer;  height:100%">
                            <div class="tarjeta-receta">
                                <div class="overlay"></div> <!-- Capa oscura -->
                                <img src="/Zava/public/recursos/Postre.jpg">
                            </div>
                        </button>
                    </form>
                    ...
                    <form method="GET" action="<?php echo BASE_URL; ?>recetario" style="height:100%;">
                        <input type="hidden" name="tipo_comida" value="panaderia">
                         <button type=submit style="background: none; border: none; padding: 0; cursor: pointer;  height:100%">
                            <div class="tarjeta-receta">
                                <div class="overlay"></div> <!-- Capa oscura -->
                                <img src="/Zava/public/recursos/Panaderia.jpg">
                            </div> 
                            </button>
                        </form>
                ...
                <div class="btn-receta">
                    <form method="GET" action="<?php echo BASE_URL; ?>recetario" style="height:100%;">
                        ...
                        <button type=submit style="background: none; border: none; padding: 0; cursor: pointer;  height:100%">
                            <div class="tarjeta-receta">
                                <div class="overlay"></div> <!-- Capa oscura -->
                                <img src="/Zava/public/recursos/Snack.jpg">
                            </div> 
                        </button>
                    </form>
                ...
                <div class="btn-receta">
                     <form method="GET" action="<?php echo BASE_URL; ?>recetario" style="height:100%;">
                        ...
                        <div class="tarjeta-receta">
                            <div class="overlay"></div> <!-- Capa oscura -->
                            <img src="/Zava/public/recursos/Bebidas.jpg"> 
                        </div>
                    </button>
                </form>
                    ...
                    <div class="cont-productos">
                        <div class="cont-general-productos superior">
                            ...
                            <div class="producto-item">
                                ...
                                <div class="cont-img">
                                    <img src="/Zava/public/recursos/Harinas--y-premezclas.png" alt="Imgagen-premezcla">
                                </div>
                            ...
                            <div class="cont-productos-chicos">
                                <div class="producto-item chico">
                                     ...
                                     <div class="cont-img">
                                        <img src="/Zava/public/recursos/galletitas.png" alt="Imgagen-galletitas">
                                    </div>
                                ...
                                <div class="producto-item chico">
                                     ...
                                     <div class="cont-img">
                                        <img src="/Zava/public/recursos/Golosinas.png" alt="Imgagen-golosinas">
                                    </div>
                                ...
                                <div class="producto-item">
                                     ...
                                     <div class="cont-img">
                                        <img src="/Zava/public/recursos/Cereales.png" alt="Imgagen-cereales">
                                    </div>
                                </div>
                                <div class="producto-item">
                                     <svg class="semicirculo-fondo"" viewBox="0 0 270 110" fill="none">
                                     ...
                                     <div class="cont-img">
                                        <img src="/Zava/public/recursos/Infusiones.png" alt="Imgagen-infusiones">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="cont-general-productos inferior">
                            ...
                            <div class="cont-productos-chicos">
                                <div class="producto-item chico">
                                     ...
                                     <div class="cont-img">
                                        <img src="/Zava/public/recursos/Aderezos.png" alt="Imgagen-aderezos">
                                    </div>
                                ...
                                <div class="producto-item chico">
                                     ...
                                     <div class="cont-img">
                                        <img src="/Zava/public/recursos/Congelados.png" alt="Imgagen-congelados">
                                    </div>
                                ...
                                <div class="producto-item">
                                     ...
                                     <div class="cont-img">
                                        <img src="/Zava/public/recursos/Snack.png" alt="Imgagen-snacks">
                                    </div>
                                </div>
                                <div class="producto-item">
                                     <svg class="semicirculo-fondo"" viewBox="0 0 270 110" fill="none">
                                     ...
                                     <div class="cont-img">
                                        <img src="/Zava/public/recursos/Bebidas.png" alt="Imgagen-bebidas">
                                    </div>
                                </div>
                            </div>
                             <div class="producto-item">
                                ...
                                <div class="cont-img">
                                    <img src="/Zava/public/recursos/Pastas-y-arroces.png" alt="Imgagen-pastas-y-arroces">
                                </div>
...
<script src="/Zava/cliente/js/busqueda.js"></script>