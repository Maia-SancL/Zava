...
?>
<div class="layout">
    <?php include $_SERVER['DOCUMENT_ROOT'] . '/Zava/public/componentes/php/menuLateral.php'; ?>
    <main>
        <?php include $_SERVER['DOCUMENT_ROOT'] . '/Zava/public/componentes/php/navegador.php'; ?>
            <link rel="stylesheet" href="<?php echo BASE_URL; ?>administrador/css/panelAdministracion.css">
            <div class="seleccionar-tipo-tabla">
                <a href="<?php echo BASE_URL; ?>administrador/panel/productos" class="tabla <?php echo ($tabla_seleccionada === 'productos') ? 'seleccionado' : ''; ?>">Productos</a>
                <a href="<?php echo BASE_URL; ?>administrador/panel/recetas" class="tabla <?php echo ($tabla_seleccionada === 'recetas') ? 'seleccionado' : ''; ?>">Recetas</a>
                <a href="<?php echo BASE_URL; ?>administrador/panel/usuarios" class="tabla  <?php echo ($tabla_seleccionada === 'usuarios') ? 'seleccionado' : ''; ?>">Usuarios</a>
                <a href="<?php echo BASE_URL; ?>administrador/panel/comentarios" class="tabla  <?php echo ($tabla_seleccionada === 'comentarios') ? 'seleccionado' : ''; ?>">Comentarios</a>
                <a href="<?php echo BASE_URL; ?>administrador/panel/usuarios_baneados" class="tabla  <?php echo ($tabla_seleccionada === 'usuarios_baneados') ? 'seleccionado' : ''; ?>">Usuarios Baneados</a>
            </div>
<?php
