                ...
                <div class="informacion-principal">
                    <div class="informacion">
                        ...
                        <span class="imagen-usuario">
                            <img src="<?php echo BASE_URL; ?>public/img/perfiles/<?= htmlspecialchars($baneado['imagen']) ?>" alt="Imagen de <?= htmlspecialchars($baneado['nickname']) ?>" style="height:32px;max-width:32px;object-fit:cover;margin-left:8px;vertical-align:middle;">
                        </span>
                    ...
                    <div class="btns">
                        <form action="<?php echo BASE_URL; ?>administrador/usuarios/unban" method="POST" onsubmit="return confirm('¿Estás seguro de que quieres quitar el baneo a este usuario?');" style="display: inline;">
