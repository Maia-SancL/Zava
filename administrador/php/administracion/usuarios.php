...
<section class="section-tabla-productos">
            ...
            <article class="producto">
                <div class="informacion-principal">
                    <div class="informacion">
                        ...
                        <span class="nombre">
    <img src="<?php echo BASE_URL; ?>public/img/perfiles/<?= htmlspecialchars($usuario['imagen']) ?>" alt="Imagen de <?= htmlspecialchars($usuario['nickname']) ?>" style="height:32px;max-width:32px;object-fit:cover;margin-right:4px;vertical-align:middle;">
    <?= htmlspecialchars($usuario['nombre']) . ' ' . htmlspecialchars($usuario['apellido']) ?> (<?= htmlspecialchars($usuario['nickname']) ?>)
                    ...
                    <div class="btns">
                        <form action="<?php echo BASE_URL; ?>administrador/usuarios/toggle" method="POST" style="display: inline;">
                        ...
                        <form action="<?php echo BASE_URL; ?>administrador/usuarios/banear" method="POST" onsubmit="return confirm('¿Estás seguro de que quieres banear a este usuario?');" style="display: inline;">
                            <input type="hidden" name="id_usuario" value="<?= $usuario['id_usuario'] ?>">
