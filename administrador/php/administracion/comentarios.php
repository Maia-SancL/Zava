            ...
            <article class="producto">
                <div class="informacion-principal">
                    ...
                    <div class="detalles-producto oculto">
                        <div class="cont-img">
                            <img src="<?php echo BASE_URL; ?>public/img/recetas/<?= htmlspecialchars($comentario['receta_imagen']) ?>" alt="Imagen de <?= htmlspecialchars($comentario['receta']) ?>" style="height:80px;max-width:80px;object-fit:cover;">
                        </div>
                    </div>
                    <div class="btns">
                        <form action="<?php echo BASE_URL; ?>administrador/comentarios/eliminar" method="POST" onsubmit="return confirm('¿Estás seguro de que quieres eliminar este comentario?');" style="display: inline;">
