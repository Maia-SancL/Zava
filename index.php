            ...
            <div class="cont-btns-recetas">
                <div class="btn-receta">
                    <div class="tarjeta-receta">
                        ...
                        <form method="POST" action="/Zava-php/php/cliente/mostrarPorCategoria.php">
                            <input type="hidden" name="categoria" value="Desayuno">
                ...
                <div class="btn-receta">
                     <div class="tarjeta-receta">
                        <div class="overlay"></div> <!-- Capa oscura -->
                            <form method="POST" action="/Zava-php/php/cliente/mostrarPorCategoria.php">
                                <input type="hidden" name="categoria" value="Almuerzo">
                                <button type=submit style="background: none; border: none; padding: 0; cursor: pointer;">
                ...
                <div class="btn-receta">
                     <div class="tarjeta-receta">
                        <div class="overlay"></div> <!-- Capa oscura -->
                            <form method="POST" action="/Zava-php/php/cliente/mostrarPorCategoria.php">
                                <input type="hidden" name="categoria" value="Merienda">
                                    <button type=submit style="background: none; border: none; padding: 0; cursor: pointer;">
                ...
                <div class="btn-receta">
                     <div class="tarjeta-receta">
                        <div class="overlay"></div> <!-- Capa oscura -->
                            <form method="POST" action="/Zava-php/php/cliente/mostrarPorCategoria.php">
                                <input type="hidden" name="categoria" value="Cena">
                                    <button type=submit style="background: none; border: none; padding: 0; cursor: pointer;">
                ...
                <div class="btn-receta">
                     <div class="tarjeta-receta">
                        <div class="overlay"></div> <!-- Capa oscura -->
                            <form method="POST" action="/Zava-php/php/cliente/mostrarPorCategoria.php">
                                <input type="hidden" name="categoria" value="Panaderia">
                                    <button type=submit style="background: none; border: none; padding: 0; cursor: pointer;">
                ...
                <div class="btn-receta">
                     <div class="tarjeta-receta">
                        <div class="overlay"></div> <!-- Capa oscura -->
                            <form method="POST" action="/Zava-php/php/cliente/mostrarPorCategoria.php">
                                <input type="hidden" name="categoria" value="Snack">
                                    <button type=submit style="background: none; border: none; padding: 0; cursor: pointer;">
